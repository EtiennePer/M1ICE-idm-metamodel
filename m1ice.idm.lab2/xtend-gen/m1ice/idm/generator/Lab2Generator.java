...
public class Lab2Generator extends AbstractGenerator {
  ...
  public CharSequence print(final StateMachine machine) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("public void next(String transition){");
      _builder.newLine();
      {
        ...
        for(final Transition transition : _transitions) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          _builder.append("if(transition.equals(\"");
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("System.out.println(\"Starting the StateMachine ... press \'exit\' to stop.\");");
      _builder.newLine();
      _builder.append("\t\t");
      ...
      String _firstLower = StringExtensions.toFirstLower(machine.getName());
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("System.out.println(\"StateMachine has been stopped.\");");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.newLine();
      _builder.append("\t");
